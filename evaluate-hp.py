...
def eval_multiple_choice(
    ...
    output_dir = os.path.join(args.save_dir, args.peft_model_name)
...
def main(args):
    ...
    model, tokenizer = load_model(args.base_model_name, args.peft_model_name)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--peft_model_name",
        type=str,
        # default="Audreygyj/peft-model-2500",
        help="The PEFT model name or path",
    )
    parser.add_argument(
        "--save_dir",
        type=str,
