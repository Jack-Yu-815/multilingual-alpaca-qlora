...
class CasualLM(LLMBase):
    ...
    def __init__(self, model_path=None, arch=None, max_tokens=1024, infer_mode="generation", lora_weights=None):
    ...
    def load_model(self, model_path=None):
        ...
        if self.lora_weights:
            print(f"> Applied LoRA weights from '{self.lora_weights}'")
