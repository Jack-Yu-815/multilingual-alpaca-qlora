...
def load_model(base_model_name, wandb_artifact_path):
    ...
    # Load the PEFT configuration from the downloaded artifact
...
def eval_multiple_choice(
    ...
    output_dir = os.path.join(args.save_dir, args.wandb_artifact_path)
...
def main(args):
    ...
    model, tokenizer = load_model(args.base_model_name, args.wandb_artifact_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--wandb_artifact_path",
        type=str,
        # default="jack-learning/huggingface/model-qlora-alpaca-ratio-0.2:v1",
        help="The wandb artifact path",
    )
    parser.add_argument(
        "--save_dir",
        type=str,
